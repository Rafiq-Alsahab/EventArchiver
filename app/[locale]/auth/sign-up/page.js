        ...
        <div className="max-w-md w-full">
          <ScrollReveal>
            <div className="text-center mb-8">
              ...
              <p className="text-amber-700">Join Mashriq and start creating stunning photo galleries</p>
            </div>
          </ScrollReveal>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-8 shadow-lg border border-amber-200">
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="pl-10 border-amber-300 focus:border-amber-500 focus:ring-amber-500 w-full py-3 border rounded-xl"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-700 mt-1">Password must be at least 8 characters</p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  variant="outline"
                  className="border-amber-300 hover:bg-amber-50 text-amber-800 flex items-center justify-center gap-2 py-3"
                >
